...
(function(win) {
	...
	*/
    ...
    InitDate.prototype = {
        init:function() {
            var that = this, opts = that.config, self = opts.dateCell[0], elem, devt, even = window.event, target;
            ...
            elem = opts.dateCell ? opts.dateCell[0] :target;
	...
	jeDt.creatlink = function(lib){
		...
		link.type = 'text/css';
		link.rel = 'stylesheet';
		link.href = '/css/jedate/' +'skin/'+ lib + '.css';
		link.id = 'jeDateSkin';
